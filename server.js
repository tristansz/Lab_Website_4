...
app.get('/home/pick_color', function(req, res) {
    ...
    .then(info => {
    	res.render('pages/home',{
				...
				color_msg: info[1][0].color_message // Return the color message
			})
    })
    .catch(err => {
            console.log('error', err);
...
app.post('/home/pick_color', function(req, res) {
	...
	var insert_statement = "INSERT INTO favorite_colors(hex_value, color_msg) VALUES('"+color_hex+"','"+color_message+"');"; // Write a SQL statement to insert a color into the favorite_colors table
...
app.get('/team_stats', function(req, res) {
	var games = "SELECT * FROM football_games WHERE game_date >= '20200831';";
	var wins = "SELECT COUNT(*) AS wins FROM football_games WHERE home_score > visitor_score;";
	var defeats = "SELECT COUNT(*) AS defeats FROM football_games WHERE home_score < visitor_score;";
	db.task('get-everything', task => {
		return task.batch([
		task.any(games),
		task.one(wins),
